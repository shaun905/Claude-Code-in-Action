...
test("MessageList renders messages with parts", () => {
      ...
      parts: [
        { type: "text", text: "Creating your component..." },
        {
          ...
          toolInvocation: {
            ...
            args: { command: "create", path: "/components/MyComponent.jsx" },
            state: "result",
            result: "Success",
          },
        },
  ...
  // Tool pill now shows a human-friendly label derived from the tool args
  expect(screen.getByText("Creating MyComponent.jsx")).toBeDefined();
});
